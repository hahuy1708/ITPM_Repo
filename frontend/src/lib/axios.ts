 ...
 * 
 * Usage:
 * import { API_BASE_URL, API_ENDPOINTS } from '@/lib/axios'
 * 
...
// VITE_API_URL is kept as a legacy fallback during migration to VITE_API_BASE_URL.
...
export const API_ENDPOINTS = {
  ...
  PROJECTS: {
    ...
    TASK_GROUPS: (id: string) => `/projects/${id}/task-groups`,
  ...
  PERMISSIONS: {
    GET: (scopeType: string, scopeId: string) => `/permissions/${scopeType}/${scopeId}`,
    UPDATE: (scopeType: string, scopeId: string) => `/permissions/${scopeType}/${scopeId}`,
  },
